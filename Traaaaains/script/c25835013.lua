...
function s.filter(c,e,tp)
	return c:IsRace(RACE_ZOMBIE) and c:IsAttackAbove(2800) and c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP_DEFENSE)
end
...
function s.thfilter(c)
	return c:IsLevel(10) and c:IsRace(RACE_ZOMBIE) and c:IsAbleToGrave()
end
