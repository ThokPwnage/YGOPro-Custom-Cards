...
function s.sptg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return c:GetFlagEffect(id)==0 and Duel.GetLocationCount(tp,LOCATION_MZONE)>0
		and Duel.IsPlayerCanSpecialSummonMonster(tp,id,0x107a207a307a,0x21,1500,1500,4,RACE_WARRIOR,ATTRIBUTE_DARK) end
...
function s.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	local c=e:GetHandler()
	if c:IsRelateToEffect(e) and Duel.IsPlayerCanSpecialSummonMonster(tp,id,0x107a207a307a,0x21,1500,1500,4,RACE_WARRIOR,ATTRIBUTE_DARK) then  
		...
		e2:SetTarget(aux.TargetBoolFunction(Card.IsSetCard,0x7a))
